...
<div class="container mt-3"> 
    <form action="../controllers/agregar_producto_venta.php" method="post" class="row">
        <div class="col-10">
    ...
    <div>
            ...
            <tbody>
                <?php foreach($_SESSION['lista'] as $lista) {?>
                    <tr>
                        ...
                        <td>
                            <a href="../controllers/quitar_producto_venta.php?id=<?php echo $lista->id?>" class="btn btn-danger">
        ...
        <form class="row" method="post" action="../controllers/establecer_cliente_venta.php">
            <div class="col-10">
        ...
        <?php if($clienteSeleccionado){?>
            <div class="alert alert-primary mt-3" role="alert">
                ...
                <a href="../controllers/quitar_cliente_venta.php" class="btn btn-warning">Quitar</a>
            </div>
        <?php }?>
        ...
        <div class="text-center mt-3">
            ...
            <a class="btn btn-primary btn-lg" href="../controllers/registrar_venta.php" target="_blank">
    <i class="fa fa-check"></i> 
    Terminar venta 
</a>
            <a class="btn btn-danger btn-lg" href="../controllers/cancelar_venta.php">
                <i class="fa fa-times"></i> 
                Cancelar
            </a>
        </div>
