...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nombre" class="form-control" value="<?php echo $producto->nombre;?>" id="nombre" placeholder="Ej. mouse">
        </div>
        <div class="row">
            <div class="col">
        ...
        <div class="text-center mt-3">
            <input type="submit" name="registrar" value="aceptar" class="btn btn-primary btn-lg">
            
            </input>
            <a href="../views/productos.php" class="btn btn-danger btn-lg">
